...
public class SayTests
{
    ...
    [Fact]
    public void Three_hundred_twenty_one()
    {
        Assert.Equal("three hundred twenty-one", Say.InEnglish(321));
    }

    [Fact]
    public void Six_hundred_seventy_nine()
    {
        Assert.Equal("six hundred seventy-nine", Say.InEnglish(679L));
    }
